...
Obtain a [CoCalc account API Key](https://doc.cocalc.com/apikeys.html) by going to [your account keys](https://cocalc.com/settings/preferences/keys), then start using CoCalc from your Python scripts. Account API keys are scoped: they must have explicit capabilities, and project/file/exec capabilities require an allowed project list.
