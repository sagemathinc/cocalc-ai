...
function usageAndExit(message, code = 1) {
  ...
  console.error(
    [
      ...
      "  --account-id <uuid>         Account id for CLI calls (defaults to dev:hub:env active account)",
      ...
      "  --help                      Show this help",
      "",
      "This script refreshes the local hub CLI env automatically via dev:hub:env",
