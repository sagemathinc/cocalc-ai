  ...
  content: (
    <>
      <PolicySection title="Notification of Copyright Infringement">
        <p>
          SageMath, Inc. ("SageMath") respects the intellectual property rights
        ...
        <p>
          ...
          that are reported to SageMath's Designated Copyright Agent, identified
        ...
        <p>
          ...
          Infringement and delivering it to SageMath's Designated Copyright
          Agent. Upon receipt of the Notice as described below, SageMath will
      ...
      <PolicySection title='DMCA Notice of Alleged Infringement ("Notice")'>
        ...
        <p>
          Deliver this Notice, with all items completed, to SageMath, Inc.'s
      ...
      <PolicySection title="DMCA Counter Notice">
        <p>
          If you believe that material you posted on or through the Sites was
          removed or disabled by mistake or misidentification, you may send a
          counter notice to SageMath's Designated Copyright Agent that includes:
        </p>
        <ol>
          <li>
          ...
          <li>
            ...
            judicial district in which SageMath may be found, and that you will
            accept service of process from the person who provided the original
            Notice or that person's agent.
          </li>
        </ol>
        <p>
          Deliver this counter notice to SageMath, Inc.'s Designated Copyright
          Agent using the contact information above.
        </p>
      </PolicySection>
    </>
  ),
