          ...
          >
            ...
            <div style={{ fontSize: "12pt" }}>
              ...
              <p>
                ...
                we do so, we’ll let you know by email. If you don’t agree to be
                bound by the modified Terms, then you may give us notice to
                terminate your use of the Service, and receive a pro-rated
                refund for any remaining part of your licence term. You may also
                give us notice to terminate your use of the Service, and receive
                a pro-rated refund for any remaining part of your licence term,
                in the event that we materially change or discontinue any
                substantial parts of our Services.{" "}
              </p>
              ...
              <p>
                ...
                non-refundable basis. Except as otherwise set out in these
                terms, there will be no refunds or credits for partial months of
                service, upgrade/downgrade refunds, or refunds for months unused
                with an open Account. No exceptions will be made. When changing
                from a monthly billing cycle to a yearly billing cycle, SMI will
                bill you for a full year upon the next monthly billing date. All
                fees due hereunder in connection with the Services are exclusive
                of all taxes, levies, or duties imposed by taxing authorities,
                and you shall be responsible for payment of all such taxes,
                levies, or duties, excluding only United States (federal or
                state) taxes on SMI’s net income. For any upgrade or downgrade
                in paid plan level while on a monthly billing cycle, you will
                automatically be charged the new rate on your next billing
                cycle. For upgrades or downgrades while on a yearly plan, SMI
                will immediately charge or refund the difference in plan cost,
                prorated for the remaining time in your yearly billing cycle.
                Downgrading your plan may cause the loss of access to Content,
                features, or capacity of your Account. SMI does not accept any
                liability for such loss. We may suspend or terminate the
                Services if fees are 30 days past due. You agree to pay, and
                authorize SMI’s third party payment processor to charge using
                your selected payment method, for all applicable fees and taxes
                that may accrue in relation to your use of the Services. The
                fees for your subscription to use the Services are set forth at{" "}
                <A href="/pricing">https://cocalc.com/pricing</A>. Pricing for
                the Services, including but not limited to monthly subscription
                plan fees, are subject to change upon thirty (30) days’ notice
                before the end of the then-current billing period. Such notice
                must be provided to you in writing in order to take effect.{" "}
              </p>
              <p>
              ...
              <p>
                ...
                Services in the event that you have materially breached these
                terms and failed to remedy such breach within 30 days of our
                ...
                Rights in Content granted by SMI); General Prohibitions and
                SMI’s Enforcement Rights; Indemnity; Limitation of Liability;
                Dispute Resolution; Governing Law and Jurisdiction; General
                Terms.{" "}
              </p>
              ...
              <p>
                SMI will indemnify and hold harmless you and your officers,
                directors, employees and agents, from and against any claims,
                disputes, demands, liabilities, damages, losses, and costs and
                expenses, including, without limitation, reasonable legal and
                accounting fees arising out of or in any way connected with (i)
                any third party claim that your use of the Services infringes
                the rights of any third party, and (ii) any breach by SMI of any
                applicable laws relating to the processing of personal
                information.
              </p>
              ...
              <p style={{ textTransform: "uppercase" }}>
                EXCEPT UNDER ANY INDEMNITY, in no event will SMI's total
                liability arising out of or in connection with THESE TERMS OR
                FROM THE USE OF OR INABILITY TO USE the ServiceS or content
                EXCEED THE AMOUNTS YOU HAVE PAID TO SMI FOR USE OF THE SERVICES
                OR content OR ONE HUNDRED DOLLARS ($100), IF YOU HAVE NOT HAD
