...
export const FEATURE_PAGES: FeaturePage[] = [
  ...
  },
  {
    slug: "slides",
    title: "Slides",
    tagline: "A focused slide-deck detail for Whiteboard & Slides.",
    summary:
  ...
  },
  {
    ...
    summary:
      "Work with notebooks, terminals, scripts, documents, RStudio, and Quarto-style workflows.",
  ...
  },
  {
    ...
    summary:
      "Use for computational math in notebooks, courses, SageTeX documents, and research.",
  ...
  },
  {
    ...
    summary:
      "Use for numerical work with notebooks, .m files, terminals, plots, and teaching.",
  ...
  },
  {
    ...
    summary:
      "For notebooks, scripts, packages, reports, and shared course or research projects.",
  ...
  },
  {
    ...
    summary:
      "Run in Jupyter notebooks, Pluto, package environments, source files, and terminals.",
  ...
  },
  {
    ...
    tagline: "Dedicated hosted capacity for heavier CoCalc project workloads.",
    summary:
      "Use dedicated hosted compute for projects that need larger or more predictable capacity.",
    image: "/public/features/terminal.png",
    index: true,
  },
  {
