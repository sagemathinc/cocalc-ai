    ...
    <Flex vertical gap={22}>
      ...
      <PublicSection>
        <Row
          ...
          gutter={[18, 18]}
        >
          <Col className="cocalc-terminal-evidence-column" lg={15} xs={24}>
            <TerminalEvidencePanel />
          </Col>
          <Col className="cocalc-terminal-context-column" lg={9} xs={24}>
            <TerminalContextGrid />
          </Col>
        </Row>
      </PublicSection>
      ...
      <PublicSection>
        <Flex vertical gap={12} style={{ maxWidth: 1180 }}>
          ...
          <Row
            ...
            gutter={[32, 18]}
          >
            <Col className="cocalc-terminal-story-card-column" lg={9} xs={24}>
              <StoryCard
                icon="file"
                title="Each terminal opens in its own folder."
              >
                Open <code>research/runs/run.term</code> and the shell starts in{" "}
                <code>research/runs/</code>. Open the <code>.term</code> file
                and the same shell context comes back with the files it reads or
                writes.
              </StoryCard>
            </Col>
            <Col className="cocalc-terminal-story-copy-column" lg={15} xs={24}>
