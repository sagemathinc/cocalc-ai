...
export const TEACHER_PAYS = "/app-docs/teaching/course-workflow";
export const STUDENT_PAYS = "/app-docs/teaching/course-workflow";
export const INSTRUCTOR_GUIDE = "/docs/teaching/course-workflow";
export const DOC_LICENSE_URL = "/app-docs/billing/settings";
export const DOC_ACCOUNT_LICENSES = "/app-docs/billing/settings";
