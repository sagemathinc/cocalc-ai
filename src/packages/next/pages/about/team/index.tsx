...
const TeamSocialMediaComponent = ({
  links,
}: Pick<SocialMediaIconListProps, "links">) => (
  <SocialMediaIconList
    style={{
      marginTop: "24px",
    }}
...
const dataSource: DataSource = [
  {
    ...
    description: (
      <>
        ...
        path. Learn more about William's remarkable career{" "}
  ...
  },
  {
    ...
    title: (
      <TitleComponent name="Harald Schilly" jobTitle="CTO at SageMath, Inc." />
    ),
    ...
    description: (
      <>
        ...
        pushing CoCalc's capabilities into new and exciting territory. Learn
        more about Harald's enthusiam for software{" "}
        <A href="/about/team/harald-schilly">here</A>, or reach out to Harald at{" "}
        <A href="mailto:hsy@sagemath.com">hsy@sagemath.com</A> for more
  ...
  },
  {
    ...
    description: (
      <>
        ...
        oversees day-to-day operations at SageMath, Inc. Learn more about
        Andrey's passion for CoCalc as an educational tool{" "}
  ...
  },
  {
    ...
    title: (
      <TitleComponent name="Blaec Bejarano" jobTitle="CSO at SageMath, Inc." />
    ),
    ...
    description: (
      <>
        ...
        differential equations to model physical phenomena. Learn more about
        Blaec's ardor for mountaineering and geophysics{" "}
        <A href="/about/team/blaec-bejarano">here</A>, or reach out to Blaec at{" "}
            ...
            <IndexList
              ...
              description={
                <>
                  ...
                  community. Each team member brings unique perspectives and
                  specializations that continue to push the development of
                  products like CoCalc and its features toward the frontier of
                  educational use and research. As you'll see, all of our
                  executive team members at SageMath, Inc. are trained
