...
const FLOW_CONTROL_PAUSE_MS = parseInt(
  process.env.COCALC_TERMINAL_FLOW_CONTROL_PAUSE_MS ?? "120",
);

const FLOW_CONTROL_MIN_BYTES = parseInt(
  process.env.COCALC_TERMINAL_FLOW_CONTROL_MIN_BYTES ?? "24576",
);

const FLOW_CONTROL_MAX_BYTES_PER_SECOND = parseInt(
  process.env.COCALC_TERMINAL_FLOW_CONTROL_MAX_BYTES_PER_SECOND ?? "196608",
);
