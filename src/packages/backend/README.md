...
Use `package.json` as the dependency reference. This package does not declare
`uuid` or `request` as dependencies; do not rely on historical transitive
