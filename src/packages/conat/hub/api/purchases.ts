...
export interface Purchases extends CreditTransferApi {
...
export const purchases = {
  ...
  getMembershipAllocationSeries: authFirstRequireAccount,
  getComputeRevenueSeries: authFirstRequireAccount,
  getMembershipAnalyticsEvents: authFirstRequireAccount,
  backfillMembershipAnalyticsPurchases: authFirstRequireAccount,
  createMembershipTier: authFirstRequireAccount,
  updateMembershipTier: authFirstRequireAccount,
  ...
  getTeamLicenseQuote: authFirstRequireAccount,
  ...
  searchSiteLicensePoolAccounts: authFirstRequireAccount,
  ...
  addSiteLicensePool: authFirstRequireAccount,
  createSiteLicenseExternalClaimPool: authFirstRequireAccount,
  addSiteLicenseExternalClaimKey: authFirstRequireAccount,
  listSiteLicenseExternalClaimPools: authFirstRequireAccount,
  disableSiteLicenseExternalClaimPool: authFirstRequireAccount,
  listSiteLicenseExternalClaimKeys: authFirstRequireAccount,
  revokeSiteLicenseExternalClaimKey: authFirstRequireAccount,
  listSiteLicenseExternalClaimConsumptions: authFirstRequireAccount,
  consumeSiteLicenseExternalClaimToken: authFirstRequireAccount,
  archiveSiteLicensePool: authFirstRequireAccount,
  setSiteLicenseManager: authFirstRequireAccount,
  removeSiteLicenseManager: authFirstRequireAccount,
  requestSiteLicensePool: authFirstRequireAccount,
  cancelSiteLicensePoolRequest: authFirstRequireAccount,
  releaseSiteLicensePoolSeat: authFirstRequireAccount,
  reviewSiteLicensePoolRequest: authFirstRequireAccount,
  getSiteLicenseAffiliationReverificationStatus: authFirstRequireAccount,
  refreshSiteLicenseAffiliationVerification: authFirstRequireAccount,
  getAIUsage: authFirstRequireAccount,
  getAccountUsageOverview: authFirstRequireAccount,
  getManagedEgressHistory: authFirstRequireAccount,
  getManagedEgressAdminOverview: authFirstRequireAccount,
  getManagedEgressAdminHistory: authFirstRequireAccount,
  getManagedCpuAdminOverview: authFirstRequireAccount,
  getManagedCpuAdminHistory: authFirstRequireAccount,
  getAdminRetentionOverview: authFirstRequireAccount,
  getAdminActiveUsersOverview: authFirstRequireAccount,
  createAbuseReviewAnnotation: authFirstRequireAccount,
  listAbuseReviewAnnotations: authFirstRequireAccount,
  revokeAbuseReviewAnnotation: authFirstRequireAccount,
  adminResetMembershipUsageWindows: authFirstRequireAccount,
};
