...
export const hosts = {
  ...
  touchProject: authFirstRequireHostWithAccountTarget,
  ...
  recordCodexSiteUsage: authFirstRequireHostWithAccountTarget,
  reserveSiteFundedCodexTurn: authFirstRequireHostWithAccountTarget,
  ...
  issueProjectHostAgentAuthToken: authFirstRequireHostWithAccountTarget,
