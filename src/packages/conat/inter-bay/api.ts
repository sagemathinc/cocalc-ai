...
import type {
  ...
  LegacyMigrationAdminPrepareProjectRemediationResponse,
  LegacyMigrationAdminApplyProjectRemediationOptions,
  LegacyMigrationAdminApplyProjectRemediationResponse,
...
export interface AccountLocalAdminRevokeAdminRoleRequest {
  account_id: string;
  actor_account_id?: string | null;
  reason?: string | null;
  metadata?: Record<string, unknown> | null;
...
export interface AccountLocalAdminRevokeAdminRoleResult {
  account_id: string;
  was_admin: boolean;
  groups: string[];
}
...
export interface AccountLocalRevokeSiteLicensePoolSeatRequest {
  actor_account_id: string;
  package_id: string;
  target_account_id?: string;
...
export interface AccountLocalAssignSiteLicensePoolSeatRequest {
  actor_account_id: string;
  package_id: string;
  target_account_id: string;
...
export interface AccountLocalRequestSiteLicensePoolRequest {
  account_id: string;
  package_id: string;
  verified_email_addresses: string[];
...
export interface AccountLocalReviewSiteLicensePoolRequest {
  actor_account_id: string;
  request_id: string;
...
export interface ProjectEnsureCourseManagerAccessRequest {
  account_id: string;
  course_project_id: string;
  course_path?: string;
  project_ids: string[];
...
export type AccountLocalMethod =
  ...
  | "legacy-migration-admin-prepare-project-remediation"
  | "legacy-migration-admin-apply-project-remediation"
...
export interface InterBayHostConnectionApi {
  ...
  releaseSeedProjectAppPublicSubdomains: (opts: {
    project_id: string;
...
const HOST_CONNECTION_METHOD_SPECS = [
  ...
  {
    name: "releaseSeedProjectAppPublicSubdomains",
    method: "release-seed-project-app-public-subdomains",
  },
  {
...
export interface InterBayHostControlApi {
  ...
  }) => ReturnType<HostControlApi["restartCloudflared"]>;
...
export interface InterBayAccountLocalApi {
  ...
  adminRevokeAdminRole: (
    opts: AccountLocalAdminRevokeAdminRoleRequest,
  ) => Promise<AccountLocalAdminRevokeAdminRoleResult>;
  setBan: (
  ...
  assignSiteLicensePoolSeat: (
    opts: AccountLocalAssignSiteLicensePoolSeatRequest,
...
export function createInterBayAccountLocalClient({
  ...
  const adminRevokeAdminRoleClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "adminRevokeAdminRole">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "admin-revoke-admin-role",
    }),
  });
  ...
  const revokeSiteLicensePoolSeatClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "revokeSiteLicensePoolSeat">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
  ...
  const assignSiteLicensePoolSeatClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "assignSiteLicensePoolSeat">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "assign-site-license-pool-seat",
    }),
  });
  ...
  >({
    ...
    subject: accountLocalSubject({
      dest_bay,
      method: "archive-site-license-pool",
    }),
  });
  ...
  const getSiteLicenseOverviewClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "getSiteLicenseOverview">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "get-site-license-overview",
    }),
  });
  const requestSiteLicensePoolClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "requestSiteLicensePool">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
  ...
  const reviewSiteLicensePoolRequestClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "reviewSiteLicensePoolRequest">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
  ...
  const legacyMigrationAdminPrepareProjectRemediationClient =
    createServiceClient<
      Pick<
        InterBayAccountLocalApi,
        "legacyMigrationAdminPrepareProjectRemediation"
    ...
    >({
      ...
      subject: accountLocalSubject({
        dest_bay,
        method: "legacy-migration-admin-prepare-project-remediation",
      }),
    });
  const legacyMigrationAdminApplyProjectRemediationClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "legacyMigrationAdminApplyProjectRemediation">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "legacy-migration-admin-apply-project-remediation",
    }),
  });
  ...
  const publicDirectoryShareListProjectClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "publicDirectoryShareListProject">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "public-directory-share-list-project",
    }),
  });
  const publicDirectoryShareCreateClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "publicDirectoryShareCreate">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "public-directory-share-create",
    }),
  });
  const publicDirectoryShareUpdateClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "publicDirectoryShareUpdate">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
      method: "public-directory-share-update",
    }),
  });
  const publicDirectoryShareUpsertClient = createServiceClient<
    Pick<InterBayAccountLocalApi, "publicDirectoryShareUpsert">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: accountLocalSubject({
      dest_bay,
  ...
  return {
    ...
    adminRevokeAdminRole: async (opts) =>
      await adminRevokeAdminRoleClient.adminRevokeAdminRole(opts),
    ...
    legacyMigrationAdminPrepareProjectRemediation: async (opts) =>
      await legacyMigrationAdminPrepareProjectRemediationClient.legacyMigrationAdminPrepareProjectRemediation(
        opts,
      ),
    legacyMigrationAdminApplyProjectRemediation: async (opts) =>
      await legacyMigrationAdminApplyProjectRemediationClient.legacyMigrationAdminApplyProjectRemediation(
        opts,
      ),
    ...
    publicDirectoryShareCreate: async (opts) =>
      await publicDirectoryShareCreateClient.publicDirectoryShareCreate(opts),
...
export function createInterBayAccountLocalHandler({
  ...
  return [
    ...
    createServiceHandler<Pick<InterBayAccountLocalApi, "adminRevokeAdminRole">>(
      {
        ...options,
        service: "inter-bay-account-local",
        subject: accountLocalSubject({
        ...
        impl: {
          adminRevokeAdminRole: async (opts) =>
            await impl.adminRevokeAdminRole(opts),
        },
      },
    ),
    ...
    >({
      ...
      impl: {
        assignSiteLicensePoolSeat: async (opts) =>
          await impl.assignSiteLicensePoolSeat(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "releaseSiteLicensePoolSeat">
    ...
    >({
      ...
      impl: {
        archiveSiteLicensePool: async (opts) =>
          await impl.archiveSiteLicensePool(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "setSiteLicenseManager">
    ...
    >({
      ...
      impl: {
        getSiteLicenseOverview: async (opts) =>
          await impl.getSiteLicenseOverview(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "requestSiteLicensePool">
    ...
    >({
      ...
      impl: {
        legacyMigrationAdminPrepareProjectRemediation: async (opts) =>
          await impl.legacyMigrationAdminPrepareProjectRemediation(opts),
      },
    }),
    createServiceHandler<
      Pick<
    ...
    >({
      ...
      impl: {
        legacyMigrationAdminApplyProjectRemediation: async (opts) =>
          await impl.legacyMigrationAdminApplyProjectRemediation(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "legacyMigrationApplyProjectRemediation">
    ...
    >({
      ...
      impl: {
        publicDirectoryShareListProject: async (opts) =>
          await impl.publicDirectoryShareListProject(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "publicDirectoryShareCreate">
    >({
      ...
      impl: {
        publicDirectoryShareCreate: async (opts) =>
          await impl.publicDirectoryShareCreate(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "publicDirectoryShareUpdate">
    >({
      ...
      impl: {
        publicDirectoryShareUpdate: async (opts) =>
          await impl.publicDirectoryShareUpdate(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "publicDirectoryShareUpsert">
    >({
      ...
      impl: {
        publicDirectoryShareUpsert: async (opts) =>
          await impl.publicDirectoryShareUpsert(opts),
      },
    }),
    createServiceHandler<
      Pick<InterBayAccountLocalApi, "publicDirectoryShareAuthorizeRead">
...
export function createInterBayProjectCollabInviteClient({
  ...
  const ensureCourseManagerAccessClient = createServiceClient<
    Pick<InterBayProjectCollabInviteApi, "ensureCourseManagerAccess">
  >({
    ...serviceClientOptions({ client, timeout }),
    subject: projectCollabInviteSubject({
      dest_bay,
