...
unset DATA COCALC_ROOT COCALC_DATA_DIR SECRETS COCALC_SECRET_SETTINGS_KEY_PATH
unset COCALC_LOCAL_PG_ENV_FILE COCALC_LOCAL_PG_SOCKET_DIR
unset CONAT_SERVER COCALC_API_URL COCALC_BEARER_TOKEN COCALC_ACCOUNT_ID
unset COCALC_BROWSER_ID COCALC_PROFILE COCALC_HUB_PASSWORD
...
case "$MODE" in
  ...
  postgres)
    ...
    export COCALC_LOCAL_PG_ENV_FILE="${COCALC_LOCAL_PG_ENV_FILE:=$COCALC_DATA_DIR/local-postgres.env}"
