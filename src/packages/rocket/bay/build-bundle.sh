...
pnpm --filter @cocalc/project-host exec ncc build "$API_V2_ROUTES_ENTRY" \
  -o "$OUT/runtime/control-plane/api-v2-routes" \
  --external bufferutil \
  --external utf-8-validate \
  --license licenses.txt

copy_native_pkg "bufferutil" "$OUT/runtime/control-plane/api-v2-routes"
copy_native_pkg "utf-8-validate" "$OUT/runtime/control-plane/api-v2-routes"
