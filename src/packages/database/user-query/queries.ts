...
export function extend_PostgreSQL<TBase extends PostgreSQLConstructor>(
  ...
  return class PostgreSQL extends ext {
    ...
    _user_set_query_project_allow_collaborator_destructive_storage_actions(
      ...args: Parameters<
        typeof userQuery._user_set_query_project_allow_collaborator_destructive_storage_actions
      >
    ) {
    ...
    _user_set_query_account_change_after(
      ...args: Parameters<typeof userQuery._user_set_query_account_change_after>
    ) {
