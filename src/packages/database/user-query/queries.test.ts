...
describe("postgres user-queries - Comprehensive Test Suite", () => {
  ...
  describe("Query Routing & Parsing Methods", () => {
    ...
    describe("_parse_get_query_opts", () => {
      ...
      test("should reject legacy changefeed requests", () => {
        ...
        expect(result?.err).toContain("changefeeds were removed");
      });
  ...
  describe("Get Query Methods", () => {
    ...
    describe("_user_get_query_where", () => {
      ...
      test("should use account_project_index membership expansion for projects automatically in multi-bay mode", (done) => {
        delete process.env.COCALC_ACCOUNT_PROJECT_INDEX_PROJECT_LIST_READS;
