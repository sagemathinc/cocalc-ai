...
backup
  ...
  .action(
    async (opts: { project?: string; indexedOnly?: boolean; limit?: string }, command: Command) => {
...
backup
  ...
  .action(
    async (opts: { project?: string; backupId: string; path?: string }, command: Command) => {
...
backup
  ...
  .action(
    async (
      opts: { project?: string; backupId: string; path?: string; dest?: string; wait?: boolean },
      command: Command,
    ) => {
...
snapshot
  ...
  .action(async (opts: { project?: string; name?: string }, command: Command) => {
...
const proxy = project.command("proxy").description("project proxy operations");
...
proxy
  ...
  .action(async (opts: { project?: string; port: string; host?: string }, command: Command) => {
