...
export const ACCOUNT_CREDENTIAL_PROFILE_METADATA_KEY =
  "cocalc_credential_profile";
export const ACCOUNT_CREDENTIAL_IDENTITY_METADATA_KEY =
  "cocalc_provider_identity";
