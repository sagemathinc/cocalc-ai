...
export const EXTRAS: SettingsExtras = {
  ...
  email_smtp_server: {
    ...
    desc: "Hostname for the main SMTP backend.",
    default: "",
  ...
  email_smtp_from: {
    name: "Primary SMTP FROM",
    desc: "FROM and REPLYTO email address for the main SMTP backend.",
    default: "",
