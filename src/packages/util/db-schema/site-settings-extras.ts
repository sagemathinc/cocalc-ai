...
export const EXTRAS: SettingsExtras = {
  ...
  launch_sla_project_start_warm_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from project start request to lifecycle running for the warm provisioned path. Blank uses 10000.",
    default: "10000",
  ...
  launch_sla_project_start_overall_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from project start request to lifecycle running across all start paths, including restore/dearchive outliers. Blank uses 5000.",
    default: "5000",
    valid: optionalPositiveInteger,
    to_val: to_trimmed_str,
    tags: ["Support", "Project Hosts"],
  ...
  launch_sla_project_jupyter_ready_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from Run Cell to the Jupyter run request being accepted. Blank uses 10000.",
    default: "10000",
    valid: optionalPositiveInteger,
    to_val: to_trimmed_str,
  ...
  launch_sla_project_exec_ready_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from an exec/compile action to project exec request acceptance. Blank uses 500.",
    default: "500",
    valid: optionalPositiveInteger,
    to_val: to_trimmed_str,
    tags: ["Support", "Project Hosts"],
  ...
  launch_sla_file_open_visible_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from file-open initiation until contents are visibly rendered. Blank uses 10000.",
    default: "10000",
    valid: optionalPositiveInteger,
    to_val: to_trimmed_str,
    tags: ["Support"],
  ...
  launch_sla_file_open_sync_ready_p95_ms: {
    ...
    desc: "Maximum acceptable P95 milliseconds from file-open initiation until realtime sync is connected and ready. Blank uses 5000.",
    default: "5000",
    valid: optionalPositiveInteger,
    to_val: to_trimmed_str,
    tags: ["Support"],
