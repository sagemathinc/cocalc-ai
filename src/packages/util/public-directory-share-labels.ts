...
export const DEFAULT_MAX_PUBLIC_DIRECTORY_SHARES_PER_ACCOUNT = 100;
export const MAX_PUBLIC_DIRECTORY_SHARE_PROJECT_PATH_LENGTH = 200;
export const MAX_PUBLIC_DIRECTORY_SHARE_SLUG_LENGTH = 120;
export const MAX_PUBLIC_DIRECTORY_SHARE_TITLE_LENGTH = 120;
export const MAX_PUBLIC_DIRECTORY_SHARE_DESCRIPTION_LENGTH = 2000;
export const MAX_PUBLIC_DIRECTORY_SHARE_LICENSE_LENGTH = 120;
