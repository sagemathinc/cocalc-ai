...
export const TIER_TEMPLATES = {
  admin: {
    ...
    usage_limits: {
      max_projects: 1000,
      max_named_agents: 1000,
      max_agent_session_members: 64,
      public_directory_shares: 1000,
      rootfs_count: 250,
  ...
  free: {
    ...
    usage_limits: {
      ...
      max_projects: 5,
      max_named_agents: 5,
      max_agent_session_members: 3,
      public_directory_shares: 25,
  ...
  instructor: {
    ...
    usage_limits: {
      ...
      max_projects: 1000,
      max_named_agents: 100,
      max_agent_session_members: 32,
      public_directory_shares: 500,
