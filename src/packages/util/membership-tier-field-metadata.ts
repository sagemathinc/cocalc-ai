...
export const MEMBERSHIP_TIER_FIELDS = [
  ...
  field({
    id: "usage_limits.browser_idle_timeout_seconds",
    path: ["usage_limits", "browser_idle_timeout_seconds"],
    card: "runtime",
    label: "Browser idle timeout",
    help: "Stop a running project after this many seconds without an authenticated CoCalc browser tab. Zero disables the policy.",
    input: "integer",
    valueType: "number",
    risks: ["capacity", "abuse"],
    unit: "seconds",
  ...
  field({
    ...
    help: "Rolling 5-hour included AI budget. 100 units equals US$1 of provider spend.",
    input: "number",
    valueType: "number",
    risks: ["hard-cost", "abuse"],
    unit: "units",
  ...
  field({
    ...
    help: "Rolling 7-day included AI budget. 100 units equals US$1 of provider spend.",
    input: "number",
    valueType: "number",
    risks: ["hard-cost", "abuse"],
    unit: "units",
  ...
  field({
    id: "usage_limits.max_named_agents",
    path: ["usage_limits", "max_named_agents"],
    card: "codex-acp",
    label: "Named agents",
    help: "Maximum active named agents in this account across all projects. Retired names and unnamed chat threads do not count.",
    input: "integer",
    valueType: "number",
    risks: ["storefront", "capacity"],
    unit: "agents",
    minimum: 0,
    integer: true,
    public: true,
  ...
  field({
    id: "usage_limits.max_agent_session_members",
    path: ["usage_limits", "max_agent_session_members"],
    card: "codex-acp",
    label: "Agent Session members",
    help: "Maximum active members in one Agent Session.",
    input: "integer",
    valueType: "number",
    risks: ["capacity", "abuse"],
    unit: "agents",
