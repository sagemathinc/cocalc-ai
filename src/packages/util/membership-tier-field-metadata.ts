...
export const MEMBERSHIP_TIER_FIELDS = [
  ...
  field({
    ...
    help: "Rolling 5-hour dedicated-host spend limit when using prepaid balance.",
    input: "currency",
    valueType: "number",
  ...
  field({
    ...
    help: "Rolling 7-day dedicated-host spend limit when using prepaid balance.",
    input: "currency",
    valueType: "number",
    risks: ["dedicated-host", "hard-cost"],
    unit: "USD",
  ...
  field({
    ...
    help: "Rolling 5-hour postpaid dedicated-host spend limit.",
    input: "currency",
    valueType: "number",
    risks: ["dedicated-host", "hard-cost"],
    unit: "USD",
  ...
  field({
    ...
    help: "Rolling 7-day postpaid dedicated-host spend limit.",
    input: "currency",
    valueType: "number",
    risks: ["dedicated-host", "hard-cost"],
    unit: "USD",
  ...
  field({
    id: "project_defaults.cores",
    path: ["project_defaults", "cores"],
    card: "advanced",
    label: "Legacy project cores",
    help: "Legacy cocalc.com per-project core quota. cocalc-ai CPU tiering uses priority and rolling CPU usage instead.",
    input: "number",
    valueType: "number",
  ...
  field({
    id: "project_defaults.cpu_shares",
    path: ["project_defaults", "cpu_shares"],
    card: "advanced",
    label: "Legacy CPU shares",
    help: "Legacy project CPU share knob. cocalc-ai uses shared compute priority instead.",
    input: "number",
    valueType: "number",
    status: "compatibility-only",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.mintime",
    path: ["project_defaults", "mintime"],
    card: "advanced",
    label: "Legacy minimum uptime",
    help: "Legacy minimum uptime setting. cocalc-ai project eviction is host-pressure and priority based.",
    input: "number",
    valueType: "number",
    status: "compatibility-only",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.network",
    path: ["project_defaults", "network"],
    card: "advanced",
    label: "Legacy network toggle",
    help: "Legacy no-network project toggle. cocalc-ai product projects always have network.",
    input: "boolean",
    valueType: "boolean",
    status: "compatibility-only",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.member_host",
    path: ["project_defaults", "member_host"],
    card: "advanced",
    label: "Legacy member host",
    help: "Legacy member-host toggle. cocalc-ai uses features.project_host_tier.",
    input: "boolean",
    valueType: "boolean",
    status: "compatibility-only",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.always_running",
    path: ["project_defaults", "always_running"],
    card: "advanced",
    label: "Legacy always running",
    help: "Legacy always-running intent. cocalc-ai does not use per-tier always-running promises.",
    input: "boolean",
    valueType: "boolean",
    status: "compatibility-only",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.ephemeral_state",
    path: ["project_defaults", "ephemeral_state"],
    card: "advanced",
    label: "Deprecated ephemeral state",
    help: "Obsolete experiment field. Do not use for cocalc-ai tiers.",
    input: "boolean",
    valueType: "boolean",
    status: "deprecated",
    risks: ["internal"],
  ...
  field({
    id: "project_defaults.ephemeral_disk",
    path: ["project_defaults", "ephemeral_disk"],
    card: "advanced",
    label: "Deprecated ephemeral disk",
    help: "Obsolete experiment field. Do not use for cocalc-ai tiers.",
    input: "boolean",
    valueType: "boolean",
    status: "deprecated",
