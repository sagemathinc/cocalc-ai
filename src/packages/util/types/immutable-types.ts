/*
There is a copy of this is @cocalc/frontend/app-framework.

We use different versions of immutable.js in frontend versus the rest,
due to the mess that immutable.js got in with the 3.x --> 4.x transition.
Our ultimate goal is to completely eliminate all use of immutable.js
in favor of immer.js, which is a much much better approach.
*/
