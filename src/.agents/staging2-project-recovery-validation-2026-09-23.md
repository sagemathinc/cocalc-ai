...
`47db6b2a-9675-4ae2-834c-3923ba0ed935`. These disposable projects remain on
...
3. The plan's full observability and scheduler contract remains broader than
   the current code: stage-specific timing and bytes, a full versioned
   ...
   due work, and mutation-boundary assignment checks are now deployed; the
   full inventory still reconciles on a 15-minute timer.
