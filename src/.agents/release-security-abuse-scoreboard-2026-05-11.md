...
- Fresh-auth gaps remain for rootfs admin mutation, organization
  membership/admin mutation if treated as equivalent to token issuance, and
  legacy auth-token generation.
