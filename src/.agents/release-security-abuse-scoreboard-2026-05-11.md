...
1. Wire the public sign-in UI to `auth/sign-in-method` so domain SSO users see
   the correct provider path before password entry.
2. Replace Google Passport configuration with admin-managed Google OIDC settings
