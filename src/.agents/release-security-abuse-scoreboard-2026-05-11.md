...
| SEC-ROOTFS-001  | Root filesystem count/storage quotas         | guarded | critical | Rootfs creation/storage is now guarded by membership-tier caps for active count, total storage, per-rootfs storage, and arbitrary remote OCI-image usage. Denials are logged as `rootfs_quota_denied`, and admins can now report top users, near-limit accounts, and recent denial groups via `cocalc admin rootfs-quotas`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Continue auditing clone/import/grow/delete paths and ownership-transfer edge cases; add user-facing current-usage display if needed for launch.                              |
...
1. Continue auditing clone/import/grow/delete paths and ownership-transfer edge
   cases.
