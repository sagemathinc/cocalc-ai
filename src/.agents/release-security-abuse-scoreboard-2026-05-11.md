...
- Fresh-auth gaps remain for rootfs admin mutation, organization
  membership/admin mutation if treated as equivalent to impersonation-link
  issuance.
