...
5. **Transfers:** define eligible prepaid-credit provenance and refund treatment;
   do not ship a raw balance-to-balance copy that launders restricted credit. [[ definitey we ust be very careful with limits; not sure what to say here]]
...
7. **Risk settings:** choose measured provider shutdown margins, initial/renewal
   ...
   silently to a customer. [[ we do already have some in place ]]
8. **Currency display:** select a maintained FX source/cache policy; keep USD entry
   and authorization for the initial release unless GBP entry is a pilot requirement. [[GBP is NOT a pilot requirement]]
